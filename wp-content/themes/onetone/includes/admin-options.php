...
QUIS SAGITTIS JUSTO. DONEC GRAVIDA, ARCU IN ALIQUET CONVALLIS</span>
            ...
            <ul class="banner-sns">
            	<li><a href="#"><img src="'.ONETONE_THEME_BASE_URL.'/images/facebook.png" alt=""></a></li>
                <li><a href="#"><img src="'.ONETONE_THEME_BASE_URL.'/images/skype.png" alt=""></a></li>
                <li><a href="#"><img src="'.ONETONE_THEME_BASE_URL.'/images/title.png" alt=""></a></li>
                <li><a href="#"><img src="'.ONETONE_THEME_BASE_URL.'/images/linkedin.png" alt=""></a></li>
                <li><a href="#"><img src="'.ONETONE_THEME_BASE_URL.'/images/google.png" alt=""></a></li>
                <li><a href="#"><img src="'.ONETONE_THEME_BASE_URL.'/images/rss.png" alt=""></a></li>
            </ul>
            </div>',
			'<div class="two_third">
            	<h3>Biography</h3>
...
viverra lacus et mi elementum mollis. Praesent eu justo elit.</p>
			...
			'<div class="one_third">
            	<img src="'.ONETONE_THEME_BASE_URL.'/images/services-icon.png" alt="">
                <h3>Service 1</h3>
...
tristique senectus et netu..</p>
            ...
            <div class="one_third">
            	<img src="'.ONETONE_THEME_BASE_URL.'/images/services-icon-2.png" alt="">
                <h3>Service 2</h3>
                <p>Donec in vehicula augue. Sed et 
nisi sem, at semper dolor. 
Pellentesque habitant morbi 
tristique senectus et netu..</p>
        	...
        	<div class="one_third last">
            	<img src="'.ONETONE_THEME_BASE_URL.'/images/services-icon-3.png" alt="">
                <h3>Service 3</h3>
                <p>Donec in vehicula augue. Sed et 
nisi sem, at semper dolor. 
Pellentesque habitant morbi 
...
feugiat quis ultrices tristique, rhoncus eu leo. In eu quam lacus. dear Praesent Donec in vehicula augue. Sed et nisi sem, at semper dolor. Pellentesque habitant morbi tristique 
senectus et netus et malesuada fames ac turpis egestas. Mauris ut urna nibh, a semper 
neque. Mauris ultrices tempus nisi, et porttitor nulla varius a. Ut turpis magna, 
feugiat quis ultrices tristique, rhoncus eu leo. In eu quam lacus. Praesent
Vehicula augue. Sed et nisi sem, at semper dolor. Pellentesque habitant morbi tristique 
...
feugiat quis ultrices tristique, rhoncus eu leo. In eu quam lacus. dear Praesent</p>'
   ...
   // HEADER
	...
	$options[] = array(
		...
		'desc' => __('An icon associated with a URL that is variously displayed, as in a browser\'s address bar or next to the site name in a bookmark list. Learn more about <a href="'.esc_url("http://en.wikipedia.org/wiki/Favicon").'" target="_blank">Favicon</a>', 'onetone'),
		'id' => 'favicon',
		'type' => 'upload');
	...
	$options[] = array(
	    ...
	    $options[] = array(
		'name' => __('Sctions Content', 'onetone'),
		'id' => 'sction_content_'.$i,
