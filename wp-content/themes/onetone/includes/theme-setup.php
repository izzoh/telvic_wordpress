...
if ( ! isset( $content_width ) ) $content_width = 720;
 ...
 function onetone_custom_scripts(){
	...
	wp_enqueue_style('onetone-main',  get_stylesheet_directory_uri() .'/style.css', false, '', false);
	wp_enqueue_style('onetone-media', ONETONE_THEME_BASE_URL.'/media.css', false, '', false);
   ...
   $onetone_custom_css = "";
	...
	if(is_home()){
	wp_enqueue_script( 'onetone-animatescroll', ONETONE_THEME_BASE_URL.'/js/jquery.smint.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'onetone-bigvideo', ONETONE_THEME_BASE_URL.'/js/jquery.tubular.1.0.js', array( 'jquery' ), '', true );
	}
	wp_enqueue_script( 'onetone-default', ONETONE_THEME_BASE_URL.'/js/onetone.js', array( 'jquery' ), '', true );
...
function onetone_script() {
?>
<script type="text/javascript">
var ajaxurl = '<?php echo admin_url('admin-ajax.php'); ?>';
var themeurl = '<?php echo ONETONE_THEME_BASE_URL; ?>';
</script>
<?php
}

add_action('wp_head','onetone_script');
